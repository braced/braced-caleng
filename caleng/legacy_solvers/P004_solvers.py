...
def P004_EC3(parts):
    ...
    if bolt_group.check(sls_forces, uls_forces, rp) and\
            ...
            plate.check_collisions_legacy(bolt_group, profile, position, rp) and\
            plate.check_t_stubs_legacy(bolt_group, uls_forces, profile, position, rp):
        rp.set_safe()
    else:
        rp.set_unsafe()
